...
The t-test show that there is a difference in average push ups between the line player and the skill player the p- value that we got is 0.0000009421, the p-value is too small that's why we reject the null hypothesis the difference is 33 push ups more than line players. 95 percent of the time the skill player do.
